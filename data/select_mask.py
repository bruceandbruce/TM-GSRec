...
def define_Mask(opt):
    ...
    #print('\033[1;31m---select_mask.py---\033[0m')
    #print('\033[1;31m---select_mask.py---\033[0m')
    #print('\033[1;31m---select_mask.py---\033[0m')
    #print('\033[1;31m---select_mask.py---\033[0m')
    #print('\033[1;31m---select_mask.py---\033[0m')
    ...
    if mask_name == 'G1D10':
        ...
        mask = loadmat(os.path.join('mask', 'fastmri', "mask_R4"))['mask_R4']
    elif mask_name == 'R8':
        mask = loadmat(os.path.join('mask', 'fastmri', "mask_R8"))['mask_R8']
    elif mask_name == 'R4_90':
        mask = loadmat(os.path.join('mask', 'fastmri', "mask_R4_90"))['mask_R4']
    elif mask_name == 'R8_90':
        mask = loadmat(os.path.join('mask', 'fastmri', "mask_R8_90"))['mask_R8']
